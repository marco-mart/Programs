...
public class Circle2Test
{
	...
	public void intersectNoIntersection() {
		...
		Circle2 a = new Circle2(0, 50, 10);
		Circle2 b = new Circle2(0, 0, 5);
		...
		a = new Circle2(16, 128, 4);
		b = new Circle2(23.45, 121.6, 5);
	...
	public void intersectCompleteOverlap() {
		...
		Circle2 a = new Circle2(0, 0, 4);
		Circle2 b = new Circle2(0, 0, 4);
	...
	public void intersectAtOnePoint() {
		...
		Circle2 a = new Circle2(0, 0, 3);
		Circle2 b = new Circle2(5, 0, 2);
	...
	public void intersectAtTwoPoints() {
		...
		Circle2 a = new Circle2(2, 0, 1);
		Circle2 b = new Circle2(4, 0, 2);
	...
	public void scaleBigger() {
		...
		Assert.assertTrue(circle2.radius == 2.0);
	}
